...
import fi.itsfactory.realtime.access.siri.vm.VMResponseFilterV2;

public class MemcachedDatasourceV2 implements SiriDatasource {
	private static final Logger logger = LoggerFactory.getLogger(MemcachedDatasourceV2.class);
	...
	public MemcachedDatasourceV2(String cacheUrl, String vmKey, String gmKey) {
        ...
        try {
            ...
            if (responseSAXParser != null) { // init failed, don't even try
                if(!latestVM.startsWith("<!DOCTYPE html")){
                     ...
                     */
                    try {
                        VMResponseFilterV2 responseFilter = new VMResponseFilterV2(lineRef, vehicleRef);
